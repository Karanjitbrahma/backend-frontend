...
const AdminApp = {
    ...
    getDefaultDataRaw() {
        return {
            site: { name: 'Bhartiya Sidhant', email: 'info@bhartiyasidhant.com', phone: '+91 98765 43210', whatsapp: '919876543210', address: 'Kokrajhar, Bodoland, Assam', facebook: '#', instagram: '#', youtube: '#', twitter: '#', telegram: '#' },
            reports: [
            ...
            courses: [
                { title: 'Vedic Astrology Foundations', desc: 'Start your journey into Jyotish Shastra. 12 Weeks, Live Online, Hindi + English. Beginner level.', image: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=400&q=80', icon: 'fa-book-open', oldPrice: '', newPrice: '14,999', link: 'https://wa.me/919876543210?text=I%20want%20to%20enroll%20in%20Vedic%20Astrology%20Beginners%20course', imgFit: 'cover', imgScale: 1 },
                { title: 'Predictive Astrology Mastery', desc: 'Become a professional Vedic astrologer. 24 Weeks, Live Online. Advanced level with 50+ case studies.', image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=400&q=80', icon: 'fa-graduation-cap', oldPrice: '', newPrice: '29,999', link: 'https://wa.me/919876543210?text=I%20want%20to%20enroll%20in%20Predictive%20Astrology%20Advanced%20course', imgFit: 'cover', imgScale: 1 },
                { title: 'Maha Vastu Shastra', desc: 'Master the science of spatial energy. 8 Weeks, Live Online. Specialized course.', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=400&q=80', icon: 'fa-compass', oldPrice: '', newPrice: '11,999', link: 'https://wa.me/919876543210?text=I%20want%20to%20enroll%20in%20Maha%20Vastu%20Shastra%20course', imgFit: 'cover', imgScale: 1 }
            ],
            services: [
            ...
            consultAcharya: [
                { title: 'Quick Guidance (15 Min)', desc: 'Single Topic Discussion, Quick Kundli Overview, Immediate Remedies, Audio/Video Call, Chat Summary After Call.', image: 'assets/images/acharya.jpg', icon: 'fa-bolt', oldPrice: '1,500', newPrice: '799', link: 'https://wa.me/919876543210?text=Hi,%20I%20want%20to%20book%20a%2015-min%20Quick%20Guidance%20session%20with%20Acharya%20Ji', imgFit: 'cover', imgScale: 1 },
                { title: 'Deep Analysis (30 Min)', desc: 'Up to 3 Topics Covered, Detailed Chart Analysis, Dasha & Transit Insights, Personalized Remedies, 7-Day Follow-up Support.', image: 'assets/images/acharya.jpg', icon: 'fa-magnifying-glass-chart', oldPrice: '2,500', newPrice: '1,499', link: 'https://wa.me/919876543210?text=Hi,%20I%20want%20to%20book%20a%2030-min%20Deep%20Analysis%20session%20with%20Acharya%20Ji', imgFit: 'cover', imgScale: 1 },
                { title: 'Complete Life Reading (60 Min)', desc: 'Unlimited Topics, Full Life Analysis — Career, Marriage, Health. Comprehensive Remedies, Video Call + PDF Report, 30-Day Priority Support.', image: 'assets/images/acharya.jpg', icon: 'fa-crown', oldPrice: '5,000', newPrice: '2,999', link: 'https://wa.me/919876543210?text=Hi,%20I%20want%20to%20book%20a%2060-min%20Complete%20Life%20Reading%20session%20with%20Acharya%20Ji', imgFit: 'cover', imgScale: 1 }
            ],
            leads: [],
    ...
    saveSettings() {
        ...
        this.data.paymentConfig = {
            ...
            whatsapp: document.getElementById('setPayWhatsapp')?.value || '919876543210',
